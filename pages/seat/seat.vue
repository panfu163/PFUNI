					...
					<view v-for="(item,index) in seatArray" :key="index" class="dp-f jc-c mt-20" :style="'width:'+boxWidth+'px;height:'+seatSize+'px'">
						<view v-for="(seat,col) in item" :key="col" class="dp-ib" :style="'width:'+seatSize+'px;height:'+seatSize+'px'"
						 @click="handleChooseSeat(index,col)">
							<image v-if="seat.type===0" class="w-100 h-100" src="../../static/pages/unselected.png" mode="aspectFit"></image>
							<image v-else-if="seat.type===1" class="w-100 h-100" src="../../static/pages/selected.png" mode="aspectFit"></image>
							<image v-else-if="seat.type===2" class="w-100 h-100" src="../../static/pages/bought.png" mode="aspectFit"></image>
						</view>
					</view>
			...
			<view class="pt-f bottom-bar left-0 dp-f fd-cr z1000">
				...
				<view class="dp-f jc-c ai-c mb-20 fz-28" v-if="showTis">
					<view class="dp-f jc-c ai-c m-0-10">
						<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="/static/pages/unselected.png" mode="aspectFit"></image><span
						 class="ml-10">可选</span>
					</view>
					<view class="dp-f jc-c ai-c m-0-10">
						<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="/static/pages/bought.png" mode="aspectFit"></image><span
						 class="ml-10">不可选</span>
					</view>
					<view class="dp-f jc-c ai-c m-0-10">
						<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="/static/pages/selected.png" mode="aspectFit"></image><span
						 class="ml-10">选中</span>
					</view>
				</view>
			</view>
...
<script>
	import seatData from '@/common/data/seat.js'
	export default {
		data() {
			return {
...
<style lang="scss" scoped>
	...
	.sel-seat {
		background: url('/static/pages/selected.png') center center no-repeat;
		background-size: 100% 100%;
	}
	
	.unsel-seat {
		background: url('/static/pages/unselected.png') center center no-repeat;
		background-size: 100% 100%;
	}
	
	.bought-seat {
		background: url('/static/pages/bought.png') center center no-repeat;
		background-size: 100% 100%;
	}
</style>
