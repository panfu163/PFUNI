<template>
	<view class="content">
		<pfRadio :labelList="labelList" @getCheckBox="getCheckBox"></pfRadio>
		<view class="h2">Radio</view>
		<view class="tip">Radio组件主要用于非模态信息提醒，无需用户交互。</view>
	 ...
	 <element contenteditable="true">{{jsData}}</element>
	  ...
	  <view class="list">
		...
		<view class="td">
			...
			<view class="td">
					  <text>duration</text>
					  <text>显示时间(如果设置为 0，则不会消失，需要手动调用组件的 hide 方法)</text>
					  <text>Number</text>
					  <text>2000</text>
					  <text>1.0.0</text>
		</view>
             ...
             <view class="td">
				  ...
				  <text>显示位置</text>
				  <text>String</text>
				  <text>placemiddle(top,bottom)</text>
				  <text>1.0.0</text>
		</view>
	  </view>
...
<script>
	import pfRadio from '../../components/Radio/Radio.vue'
		export default {
			components: {
				pfRadio,
			},
