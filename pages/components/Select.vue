<template>
	<view class="content">
		...
		<view class="tip">Select组件主要用于非模态信息提醒，无需用户交互。</view>
	 ...
	 <element contenteditable="true">{{jsData}}</element>
	  ...
	  <view class="list">
		...
		<view class="td">
			...
			<view class="td">
					  <text>initValue</text>
					  <text>第一次显示时默认选中的文本</text>
					  <text>String</text>
					  <text>无</text>
					  <text>1.0.0</text>
		</view>
		       <view class="td">
				  <text>isCanInput</text>
				  <text>是否可以输入值</text>
				  <text>Boolean</text>
				  <text>false</text>
				  <text>1.0.0</text>
       ...
       <view class="td">
		 ...
		 <view class="td">
						  <text>style_Container</text>
						  <text>组件根节点的行内样式</text>
						  <text>String</text>
						  <text>无</text>
						  <text>1.0.0</text>
				</view>
			...
			<view class="td">
								  <text>showItemNum</text>
								  <text>显示列表的窗口高度，数字表示能显示几个列表项</text>
								  <text>Number</text>
								  <text>5</text>
								  <text>1.0.0</text>
			</view>
			<view class="td">
								  <text>listShow</text>
								  <text>第一次显示时是否显示列表</text>
								  <text>Boolean</text>
								  <text>false</text>
								  <text>1.0.0</text>
			</view>
			<view class="td">
								  <text>isCheckbox</text>
								  <text>是否显示多选</text>
								  <text>Boolean</text>
								  <text>false</text>
								  <text>1.0.0</text>
...
<script>
	import Select from '../../components/Select/Select.vue';     //导入
		export default {
			components: {
				Select,
			},
